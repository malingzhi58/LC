package com.geekbang.learnfile.geekbang.learnthrread.src.com.geekbang.join;
...
public class ThreadJoinAppMain {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        long mainWorkDuration = TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis() - mainStart) ;


        // TODO 多线程的意义就是让工作并发的处理，使用更多的资源（CPU，磁盘，网络等），以便让工作更快的完成。
        System.out.println("工作线程累计工作时间：" + TimeUnit.MILLISECONDS.toSeconds(WORKING_DURATION) );
